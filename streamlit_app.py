...
# client = MongoClient("mongodb+srv://cron_job:q1TTOjp5iDy61koy@cluster0.cxfiw.mongodb.net/?retryWrites=true&w=majority")
# from deta import app

# 61c5907ef17b4401dadec539
# xaeuvwce
# cd5d5cfb-c369-49e0-be7a-e3c564b3f0a5
...
def my_cron_job():
    ...
    def save_articles_to_database():
        try:
            ...
            print("faild to save")
        # url_science = 'http://localhost:4000/article/science'
        # url_health = 'http://localhost:4000/article/health'
        
        # myobj_science = {
        #     'data': science_articles
        # }
        # myobj_health = {
        #     'data': science_articles
        # }
        ...
        # xs = requests.post(url_science, json = myobj_science)
        # xh = requests.post(url_health, json = myobj_health)
        # print(xs,xh)
...
with st.echo(code_location='below'):
    ...
    fire_at = st.slider("Number of turns in spiral", 1, 100, 9)
